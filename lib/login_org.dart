...
import 'package:na_hack/register_org.dart';
...
class LoginOrgPage extends StatefulWidget {
  ...
  @override
  State<LoginOrgPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginOrgPage> {
  ...
  void signUserIn() async {
    ...
    // Try sign in
    try {
      // Query Firestore to find user with the given username
      var userDoc = await FirebaseFirestore.instance
          .collection(
              'organizations') // Change this to the appropriate collection
      ...
      String organizationId = userDoc.docs.first.id; // Get the document ID
      ...
      // Navigate to DashboardOrg and pass the organization ID
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => DashboardOrg(organizationId: organizationId),
        ),
      );
