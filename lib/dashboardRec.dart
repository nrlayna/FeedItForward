...
class DashboardRec extends StatefulWidget {
  final String recId;

  DashboardRec({required this.recId});

  @override
  _DashboardRec createState() => _DashboardRec();
}

class _DashboardRec extends State<DashboardRec> {
  bool isLoading = true;
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => ReqRcp(recId: widget.recId),
            ),
          );
  ...
  Widget _campaignCard(Map<String, dynamic> campaign) {
    ...
    return GestureDetector(
      onTap: () {
        // Pass the document ID to the CampaignDetail
        Navigator.of(context).push(
          MaterialPageRoute(
