...
import 'package:na_hack/register_rec.dart';

class LoginRecPage extends StatefulWidget {
  ...
  @override
  State<LoginRecPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginRecPage> {
  ...
  void signUserIn() async {
    ...
    try {
      ...
      var userDoc = await FirebaseFirestore.instance
          .collection('recepients') // Change this to the appropriate collection
      ...
      String recId = userDoc.docs.first.id;
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => DashboardRec(recId: recId),
        ),
      );
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => RegisterRecPage(),
                          ),
                        );
                      },
                      child: const Text(
